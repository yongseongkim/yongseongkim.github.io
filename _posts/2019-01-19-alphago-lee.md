...
![distribution]({{site.url}}/images/20190119-alphago-lee/next-step-distribution.png){: width="50%" }
...
![Policy Network, Value network 의 Output]({{site.url}}/images/20190119-alphago-lee/policy-value-network-output.png){: width="50%"}
...
![Value Network 성능 비교]({{site.url}}/images/20190119-alphago-lee/value-network-mse-compare.png)
...
![Monte Carlo Example]({{site.url}}/images/20190119-alphago-lee/Pi_30K.gif){: width="50%"} 
...
![MCTS Selection]({{site.url}}/images/20190119-alphago-lee/mcts-step-selection.png){: width="50%"} 

<small>이미지 출처: Mastering the game of Go with deep neural networks and tree search</small>

먼저 위 그림과 같이 루트에서 $$Q+u(p)$$ 큰 값의 상태를 따라 내려갑니다. 

![MCTS Expansion]({{site.url}}/images/20190119-alphago-lee/mcts-step-expansion.png){: width="50%"} 
...
![MCTS Evaluation]({{site.url}}/images/20190119-alphago-lee/mcts-step-evaluation.png){: width="50%"} 
...
![MCTS Backup]({{site.url}}/images/20190119-alphago-lee/mcts-step-backup.png){: width="50%"} 
