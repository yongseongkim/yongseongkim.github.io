...
<small>이미지 출처: [hareenlaks's blog](http://hareenlaks.blogspot.com/2011/04/history-of-steganography.html#more)</small>
...
인형 딜러로 위장한 스파이는 얼마나 많은 인형을 배에 실을 지에 대한 주문서에 메시지를 숨겨 배의 움직임을 알렸습니다.
...
![Word Shift Coding Example]({{site.url}}/images/20200209-introduction-to-steganography/text-technique-word-shift-coding.png)
...
![Stegenography Image Technique Example]({{site.url}}/images/20200209-introduction-to-steganography/img-technique-wechall-example.png)
...
![Stegenography Image Technique Example - Insertion]({{site.url}}/images/20200209-introduction-to-steganography/img-technique-wechall-insertion.png)
...
![Stegenography Image Technique Example - LSB]({{site.url}}/images/20200209-introduction-to-steganography/img-technique-wechall-lsb.png)
...
![Stegenography Image Technique Example - LSB - 0]({{site.url}}/images/20200209-introduction-to-steganography/img-technique-wechall-lsb-idx0.png)

<small>BLUE 1 번 비트와 AND 연산한 결과</small>
![Stegenography Image Technique Example - LSB - 0]({{site.url}}/images/20200209-introduction-to-steganography/img-technique-wechall-lsb-idx1.png)

위와 같이 메세지가 숨겨져 있는 것을 볼 수 있습니다.
이 방법은 비트가 올라가면 올라갈수록 원 이미지를 훼손하게 됩니다.

![Stegenography Image Technique Example - LSB - Bit Used]({{site.url}}/images/20200209-introduction-to-steganography/img-technique-lsb-bit-used.jpg)
...
![Stegenography Image Technique Example - Deep Learning Network]({{site.url}}/images/20200209-introduction-to-steganography/img-technique-deep-learning-network.png)
...
![Stegenography Image Technique Example - Deep Learning]({{site.url}}/images/20200209-introduction-to-steganography/img-technique-deep-learning.png)
...
![Stegenography Sound Technique Example]({{site.url}}/images/20200209-introduction-to-steganography/sounnd-technique-example.png)
