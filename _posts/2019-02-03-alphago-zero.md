...
![MCTS in training]({{site.url}}/images/20190203-alphago-zero/mcts-training-data.png){: width="100%" }
...
![MCTS Leaning]({{site.url}}/images/20190203-alphago-zero/mcts-learning.png){: width="100%" }
...
![MCTS Leaning]({{site.url}}/images/20190203-alphago-zero/mcts-step.png){: width="100%" }
...
![MCTS Leaning]({{site.url}}/images/20190203-alphago-zero/elo-rating.png)
...
![MCTS Leaning]({{site.url}}/images/20190203-alphago-zero/prediction-professional-move.png)
