...
예를 들어 페이스북 앱 Associated Domains 에 facebook.com 을 도메인으로 명시하면, 명시한 도메인/apple-app-site-association 형식으로(여기서는 facebook.com/apple-app-site-association) AASA 파일을 서버에서 제공해야 합니다.
