...
<br>
![SwiftUI Layout System]({{site.url}}/images/20200525-swiftui-layout-system/screen-without-safearea.png){: width="30%" }
<br>
...
![Text in Root]({{site.url}}/images/20200525-swiftui-layout-system/text-in-root.png){: width="40%" }
![Color in Root]({{site.url}}/images/20200525-swiftui-layout-system/color-in-root.png){: width="40%" }
<br>
Text 는 Parent 에게 전달받은 영역이 아무리 커도 컨텐츠 만큼 크기를 차지하는 반면에 Color 는 부모가 제시한 크기만큼 크기를 차지합니다.

Image 는 `resizable` modifier 에 따라 동작이 다릅니다. `resizable` 을 사용하지 않은 Image 는 지 크기 만큼 영역을 차지합니다.
하지만 `resizable` modifier 가 붙으면 이미지를 가능한 영역만큼 늘려서 보여 줍니다.
{% gist 02f863d0aa0aa52dcda49a9bf6b8ed7d compare-with-or-without-resizable.swift %}
![Preview of Image without resizable]({{site.url}}/images/20200525-swiftui-layout-system/image-preview-without-resizable.png){: width="40%" }
![Preview of Image with resizable]({{site.url}}/images/20200525-swiftui-layout-system/image-preview-with-resizable.png){: width="40%" }
<br><br>
...
![Compare views in stack]({{site.url}}/images/20200525-swiftui-layout-system/compare-text-image-text-in-stack.png){: width="80%" }
<br>
...
<br>
![Fit and Fill views in stack]({{site.url}}/images/20200525-swiftui-layout-system/fit-fill-in-stack.png){: width="80%" }
<br><br><br>
...
<br>
![Alignment last text baseline]({{site.url}}/images/20200525-swiftui-layout-system/alignment-last-text-baseline.png){: width="80%" }
...
![Example of custom alignmentGuide]({{site.url}}/images/20200525-swiftui-layout-system/custom-alignment-guide.png){: width="80%" }
<br><br><br>
